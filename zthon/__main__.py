...
import Avatar 
from Avatar  import BOTLOG_CHATID, PM_LOGGER_GROUP_ID
...
print(Avatar .__copyright__)
print(f"المرخصة بموجب شروط  {Avatar .__license__}")

cmdhr = Config.COMMAND_HAND_LER

try:
    LOGS.info("⌭ بـدء تنزيـل افاتار ⌭")
...
async def startup_process():
    ...
    LOGS.info(f"⌔┊تـم تنصيـب افاتار . . بنجـاح ✓")
    await verifyLoggerGroup()
