...
ZelzalSelf_cmd = (
    "𓆩 [ᯓ 𝗦𝗼𝘂𝗿𝗰𝗲 𝐀𝐕𝐀𝐓𝐀𝐑  - حفـظ الذاتيـه 🧧](t.me/sourceav) 𓆪\n\n"
    "**⪼** `.تفعيل الذاتيه`\n"
    ...
    "\n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 𝐀𝐕𝐀𝐓𝐀𝐑 ](t.me/sourceav) 𓆪"
)
