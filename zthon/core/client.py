            ...
            async def wrapper(check):  # sourcery no-metrics
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext += "\n\n--------نهـاية سجـل تتبـع افاتار𝐀𝐕𝐀𝐓𝐀𝐑 --------"
                        ...
                        link = "[𐇮 𝗠𝗢𝗡𝗭𝗘𝗥 𖠮 الهہـيـٖ͡ـ͢ـبـه 𐇮](https://t.me/Z_X_Z_B)"
                        text = (
                            "**✘ تقـريـر اشعـار افاتار𝐀𝐕𝐀𝐓𝐀𝐑  ✘**\n\n"
            ...
            async def wrapper(check):
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**✘ تقـريـر اشعـار افاتار𝐀𝐕𝐀𝐓𝐀𝐑  ✘**\n\n "
                        link = "[𐇮 𝗠𝗢𝗡𝗭𝗘𝗥 𖠮 الهہـيـٖ͡ـ͢ـبـه 𐇮](https://t.me/Z_X_Z_B)"
