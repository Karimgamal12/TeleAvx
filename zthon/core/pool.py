...
def _stop():
    ...
    _LOG.info(_LOG_STR, f"اووبس لم يتم تنصيب جميع مكاتب افاتار : {_EXECUTOR._max_workers} ")


# pylint: disable=protected-access
_LOG.info(_LOG_STR, f" تم بنجـاح تنصيب جميع مكاتب افاتار : {_EXECUTOR._max_workers} ")
